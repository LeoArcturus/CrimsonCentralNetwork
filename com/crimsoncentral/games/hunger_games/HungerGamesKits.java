...
public class HungerGamesKits {
	...
	public static void setupSoloKitSelector() {
		...
		if (kits_setup != true) {
			...
			HungerGamesKits.solo_kit_selector.opener = new ItemStack(Material.CHEST, 1);

			ItemMeta meta = HungerGamesKits.solo_kit_selector.opener.getItemMeta();
			meta.setDisplayName(ChatColor.RED + "Sky Wars Solo Kit Selector");

			HungerGamesKits.solo_kit_selector.opener.setItemMeta(meta);
			...
			default_kit.createKit(HungerGamesKits.solo_kit_selector);
			...
			warrior.createKit(HungerGamesKits.solo_kit_selector);
			...
			archer.createKit(HungerGamesKits.solo_kit_selector);
			...
			armor.createKit(HungerGamesKits.solo_kit_selector);
			...
			bolt.createKit(HungerGamesKits.solo_kit_selector);

			HungerGamesKits.solo_kit_selector.registerKitInventory();
			kits_setup = true;
		}
	}
